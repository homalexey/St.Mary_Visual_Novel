...
define config.name = _("Saint Maria")
...
define gui.about = _p("""Эта игра - демонстрация моих навыков и амбиций в сфере нарративного дизайна и сценаристики.

Картинки сгенерированны в Шедевруме, GigaChat и ChatGPT, прошли апскейл в бесплатных веб-сервисах и мою пост-обработку.

Музыка моего авторства.
...
define config.main_menu_music = "Alien.mp3"
...
define config.save_directory = "SaintMaria-1754833686"
